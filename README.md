...
Commentaires : De bonnes améliorations mises en oeuvre attestent que Greg a réalisé les recherches adéquates.

### 2. Optimiser la taille et la vitesse d’un site web

*Validé*

Commentaires : De bons axes d'optimisation, avec démonstrations flagrantes des résultats obtenus.

### 3. Assurer l'accessibilité d'un site web

*Validé*

Commentaires : Greg a testé un outil utilisé pour "écouter" un site. Très bonne démarche ! Les résultats d'amélioration de l'accessibilité sont là.

### 4. Écrire un code HTML et CSS maintenable

*Validé*

Commentaires : Le code est propre, les améliorations n'ont pas amené de régression. Le code est validé W3C.

### 5. Optimiser le référencement d'un site web

*Validé*

Commentaires : Les divers outils utilisés pour évaluer le niveau de référencement attestent des améliorations apportées.

### Livrable

#### Points forts

Excellents documents fournis.

#### Axes d'amélioration

Donner les liens vers les sites expliquant les améliorations proposées

### Soutenance

Remarques : Excellente soutenance de Greg. Il a su parfaitement expliquer son travail, son support de présentation est d'excellente facture, on voit bien que Greg maîtrise l'ensemble des améliorations proposées et il sait parfaitement en expliquer le pourquoi du comment. Greg est à l'aise pour expliquer, il a su s'adapter à mes questions durant sa présentation, bref un très bon moment passé et la qualité du travail réalisé l'a d'autant plus rendu appréciable. Bravo !Remarques sur l'évaluation
Compétences évaluées
